...
# side is {} The right side is {10,-80,10,10,15,35} They both are equal to 0 when
# added. (Empty arrays are equal to 0 in this problem) Index 0 is the place where
...
# side to the right of N. If you do not find an index that fits these rules, then
# you will return -1.
