...
# squared, regardless of the order. Examples Valid arrays

#   a = [121, 144, 19, 161, 19, 144, 19, 11]  b = [121, 14641, 20736, 361, 25921,
#   361, 20736, 361]
...
#   a or b might be [] or {} (all languages except R, Shell). a or b might be nil
#   or null or None or nothing (except in C++, COBOL, Crystal, D, Dart, Elixir,
#   Fortran, F#, Haskell, Nim, OCaml, Pascal, Perl, PowerShell, Prolog,
