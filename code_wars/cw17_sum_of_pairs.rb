...
# #          ^-----^         4 + 2 = 6, indices: 0, 2 * ^-----^      3 + 3 = 6,
# #          indices: 1, 3 ^-----^   2 + 4 = 6, indices: 2, 4 * the correct
# #          answer is the pair whose second value has the smallest index
# == [4, 2]
...
# #              ^-----------^   5 + 5 = 10, indices: 1, 5 ^--^      3 + 7 = 10,
# #              indices: 3, 4 * * the correct answer is the pair whose second
